...
$(function(){
	...
	// {
	// 	data[i] = { label: "Series66"+(i+1), data: Math.floor(Math.random()*100)+1 }
	// }
    ...
    {
        data[i] = { label: initData[i].name, data: initData[i].price }
        d1.push([i, parseInt(initData[i].price)]);
    }
